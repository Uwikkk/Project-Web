...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            <h2 class="text-center">Daftar Slider</h2>
            <hr>
            ...
            @endif
            <a href="{{ url('admin/slider/create') }}" class="btn btn-primary btn-user mb-3">Tambah Data</a>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ url('admin/slider/edit/'.$dt->id) }}" class="btn btn-primary">Edit</i></a>
                            <a href="{{ url ('admin/slider/delete/'.$dt->id) }}" class="btn btn-danger">Hapus</i></a>
                        </td>
                    </tr>
                    @endforeach();
                </tbody>
