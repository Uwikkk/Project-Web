...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h2 class="my-3 text-center text-dark">Form Update Data Main Menu</h2>
            <hr>
        </div>
        <div class="col-md-7">
            <div class="col-md">
            ...
            <form action="{{ url('admin/mainmenu/edit/' . $data->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="parent" id="parent" class="form-control">
                            ...
                            <option value="{{$cat->id}}" {{ ($cat->id == $data->id) ? 'selected' : '' }}>{{$cat->tittle}}</option>
                            @endforeach
                ...
                <div id="files">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" name="file" class="form-control" id="file" value="{{$data->file}}">
                        </div>
                    </div>
                </div>
                <div id="links">
