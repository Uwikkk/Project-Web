    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            ...
            <a href="#TambahData" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                <h6 class="m-0 font-weight-bold text-primary">Tambah Jenis Pupuk</h6>
            </a>
            <div class="collapse show" id="TambahData">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('admin/pupuk/create') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="nama_pupuk">Nama Pupuk</label>
                            <input type="text" name="nama_pupuk" id="nama_pupuk" class="form-control" autofocus required>
                        </div>
                        ...
                        <table class="table table-striped table-hover" id="DataTabel">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $dt->nama_pupuk }}</td>
                                    <td>
                                        <a href="{{ url ('/admin/pupuk/edit/'.$dt->id) }}" class="btn btn-circle btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                        <a href="#" data_id="{{ $dt->id }}" data_nama="{{ $dt->nama_pupuk }}" class="btn btn-circle btn-danger btn-sm hapus"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
