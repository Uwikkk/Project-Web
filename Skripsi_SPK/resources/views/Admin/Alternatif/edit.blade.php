        ...
        <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="TambahData">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('/admin/alternatif/edit/' .$data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" value="{{ $data->id }}">
                        <div class="form-group">
                            <label for="nama_alternatif">Nama Alternatif</label>
                            <input type="text" name="nama_alternatif" id="nama_alternatif" class="form-control" autofocus required value="{{ $data->nama_alternatif }}">
                        </div>
